...
let context = "Hi Lover! Generate a 4-line romantic poem. Make sure to follow the instructions below.";let prompt = 'Instructions: Generate the poem about ${instructionsInput.value}.';
